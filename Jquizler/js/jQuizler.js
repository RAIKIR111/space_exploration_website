        ...
        jQuizler: function(questions) {
            ...
            return this.each(function(){
                ...
                $.each(questions, function(index, question){
                    ...
                    html += "<div class=\"notice alert alert-info\">Choose your answer</div>";

                    if (index != 0) {
                        html += "<button class=\"prev btn btn-info\"><i class='icon-arrow-left icon-white'></i>Previous</button>";
                    }

                    if (index != questions.length-1) {
                        html += "<button class=\"next btn btn-success\">Next <i class='icon-arrow-right icon-white'></i></button>";
                        html += "<div style=\"clear:both\"></div>";

                    } else {
                        html += "<button class=\"final btn btn-success\">Results <i class='icon-ok icon-white'></i></button>";
                        html += "<div style=\"clear:both\"></div>";
                    }
                ...
                $(".final").click(function(e){
                    ...
                    if (userAnswer.index() == -1 && !reviewQuiz) {
                        ...
                        var resultHTML = "<h3 style=\"text-align: center\">RESULTS</h3>";
                        ...
                        $.each(questions, function(index, question){
                            ...
                            if (element.index() == question.correct) {
                                ...
                                buttonsHTML += "<button class=\"btn btn-success\"><i class='icon-ok-sign icon-white'></i> Question " + (index+1) + "</button>";
                                rightAnswers++;
                            } else {
                                element.removeClass("btn-info");
                                element.addClass("btn-danger");

                                buttonsHTML += "<button class=\"btn btn-danger\"><i class='icon-remove-sign icon-white'></i> Question " + (index+1) + "</button>";
                        ...
                        resultHTML += "<p style=\"margin-top:25px; text-align: center\"><button class=\"btn btn-large tostart\">View questions</button></p>";
